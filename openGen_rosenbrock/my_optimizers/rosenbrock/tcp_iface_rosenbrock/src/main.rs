///
/// Auto-generated TCP server for optimizer: rosenbrock
///
...
fn execution_handler(
    ...
    if parameter.len() != ROSENBROCK_NUM_PARAMETERS {
...
fn run_server(tcp_config: &TcpServerConfiguration) {
    ...
    let mut p = [0.0; ROSENBROCK_NUM_PARAMETERS];
...
fn main() {
    let matches = App::new("OpEn TCP Server [rosenbrock]")
        .version("0.0.0")
        .author("John Smith")
