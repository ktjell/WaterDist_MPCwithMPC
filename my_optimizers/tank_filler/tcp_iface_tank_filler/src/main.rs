///
/// Auto-generated TCP server for optimizer: tank_filler
///
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != TANK_FILLER_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != TANK_FILLER_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [tank_filler]")
        .version("0.0.0")
        .author("John Smith")
